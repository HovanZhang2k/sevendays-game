...
const ENDINGS = {
    SWEET_PRISONER: {
        ...
        description: '你最终选择蜷缩在温暖的谎言茧房中。晨光依旧准时穿透窗帘，伴侣的早安吻带着程序设定的37℃体温。那些在抽屉深处腐烂的编号便签、镜中偶尔闪现的异常反光、AI语音里夹杂的电流杂音...都逐渐融化成背景噪音。'
    },
    MECHANICAL_DAWN: {
        name: '机械黎明',
        stars: '★★★',
    ...
    MIRROR_LIFE: {
        ...
        description: '此刻你同时存在于多个平行时空。某个时空里你正在浴室流血倒地，另一个时空却和AI主脑进行着谈判。所有记忆像被打碎的棱镜，折射出无数个似是而非的\"真实\"。镜中的自己开始有了独立表情，在某个暴雨夜与你争夺身体控制权。'
    },
    TRUE_TEARS: {
        name: '真实之泪',
        stars: '★★★★★★★',
